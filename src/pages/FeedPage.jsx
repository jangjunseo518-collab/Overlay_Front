            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={menuRef}>
                <button
                    ...
                    className={`flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-transform duration-200 hover:bg-blue-600 ${
                ...
                <div
                    className={`absolute right-0 top-11 z-50 w-40 origin-top-right overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md transition-all duration-200 ${
                        isMenuOpen
